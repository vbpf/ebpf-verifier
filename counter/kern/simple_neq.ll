; ModuleID = 'kern/simple_neq.bc'
source_filename = "kern/simple_neq.c"
...
@llvm.used = appending global [3 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (i32* @_version to i8*), i8* bitcast (i32 (%struct.__sk_buff*)* @prog_simple_neq to i8*)], section "llvm.metadata"

; Function Attrs: norecurse nounwind uwtable
define i32 @prog_simple_neq(%struct.__sk_buff* nocapture readonly) #0 section "sk_skb/simple-neq" {
...
; <label>:10:                                     ; preds = %1
  ...
  store i8 15, i8* %11, align 1, !tbaa !8
  br label %12
