...
@llvm.used = appending global [3 x i8*] [i8* getelementptr inbounds ([4 x i8], [4 x i8]* @_license, i32 0, i32 0), i8* bitcast (i32* @_version to i8*), i8* bitcast (i32 (%struct.__sk_buff*)* @prog_simple_lt to i8*)], section "llvm.metadata"

; Function Attrs: norecurse nounwind uwtable
define i32 @prog_simple_lt(%struct.__sk_buff* nocapture readonly) #0 section "sk_skb/simple-lt" {
  %2 = getelementptr inbounds %struct.__sk_buff, %struct.__sk_buff* %0, i64 0, i32 15
  %3 = load i32, i32* %2, align 4, !tbaa !2
  %4 = getelementptr inbounds %struct.__sk_buff, %struct.__sk_buff* %0, i64 0, i32 16
...
; <label>:7:                                      ; preds = %1
  ...
  store i8 1, i8* %9, align 1, !tbaa !8
  br label %10
