...
static void close_over_edge(SplitDBM::graph_t& g, SplitDBM::vert_id ii, SplitDBM::vert_id jj) {
    using graph_t = SplitDBM::graph_t;
    using Weight = SplitDBM::Weight;
    using vert_id = SplitDBM::vert_id;
    assert(ii != 0 && jj != 0);
