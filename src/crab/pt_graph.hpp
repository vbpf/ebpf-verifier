...
class PtGraph : public ikos::writeable {
  public:
    ...
    template <class Wo>
    PtGraph(const PtGraph<Wo> &o) : edge_count(0) {
    ...
    PtGraph(const PtGraph<Wt> &o)
        : edge_count(o.edge_count), _succs(o._succs), _preds(o._preds), is_free(o.is_free), free_id(o.free_id) {}
    ...
    class mut_val_ref_t {
      ...
      public:
        ...
        mut_val_ref_t(graph_t &_g, vert_id _s, vert_id _d) : g(&_g), s(_s), d(_d), w(g->succs(s).value(d)) {}
