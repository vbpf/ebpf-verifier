...
inline linear_expression_t operator+(variable_t x, number_t n) { return linear_expression_t(x).operator+(std::move(n)); }

inline linear_expression_t operator+(variable_t x, int n) { return linear_expression_t(x).operator+(n); }

inline linear_expression_t operator+(number_t n, variable_t x) { return linear_expression_t(x).operator+(std::move(n)); }
...
inline linear_expression_t operator+(number_t n, const linear_expression_t& e) { return e.operator+(std::move(n)); }
...
inline linear_expression_t operator-(number_t n, variable_t x) {
    return linear_expression_t(number_t(-1), x).operator+(std::move(n));
}
...
inline linear_expression_t operator-(number_t n, const linear_expression_t& e) {
    return linear_expression_t(std::move(n)).operator-(e);
}
...
inline linear_constraint_t operator<=(number_t n, const linear_expression_t& e) {
    return linear_constraint_t(std::move(n) - e, linear_constraint_t::INEQUALITY);
}
...
inline linear_constraint_t operator<=(number_t n, variable_t x) {
    return linear_constraint_t(std::move(n) - x, linear_constraint_t::INEQUALITY);
}
...
inline linear_constraint_t operator<(number_t n, const linear_expression_t& e) {
    return linear_constraint_t(std::move(n) - e, linear_constraint_t::STRICT_INEQUALITY);
}
...
inline linear_constraint_t operator<(number_t n, variable_t x) {
    return linear_constraint_t(std::move(n) - x, linear_constraint_t::STRICT_INEQUALITY);
}
