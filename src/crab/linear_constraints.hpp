...
class disjunctive_linear_constraint_system {
  ...
  public:
    ...
    disjunctive_linear_constraint_system(bool is_false = false) : _is_false(is_false) {}

    explicit disjunctive_linear_constraint_system(const linear_constraint_system_t &cst) : _is_false(false) {
        if (cst.is_false()) {
            _is_false = true;
        } else {
            _csts.push_back(cst);
    ...
    disjunctive_linear_constraint_system(const this_type &o) : _csts(o._csts), _is_false(o._is_false) {}

    disjunctive_linear_constraint_system(this_type &&o) : _csts(std::move(o._csts)), _is_false(o._is_false) {}
