...
//     virtual Dom widening_thresholds(const Dom& abs, const crab::iterators::thresholds<number_t> &ts) = 0;

//     /**************************** Backward arithmetic operations ******************/
//     // x = y op z
//     // Substitute x with y op z in the abstract value
//     // The result is meet with invariant.
//     virtual void backward_apply(operation_t op, variable_t x, variable_t y, variable_t z, const Dom& invariant) = 0;
//     // x = y op k
//     // Substitute x with y op k in the abstract value
//     // The result is meet with invariant.
//     virtual void backward_apply(operation_t op, variable_t x, variable_t y, number_t k, const Dom& invariant) = 0;
//     // x = e
//     // Substitute x with e in the abstract value
//     // The result is meet with invariant.
//     virtual void backward_assign(variable_t x, linear_expression_t e, const Dom& invariant) = 0;
