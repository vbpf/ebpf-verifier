...
z_number::operator mpz_class() const { return _n; }
...
std::string z_number::get_str() const { return _n.get_str(); }
...
bool z_number::fits_sint() const { return _n.fits_sint_p(); }

bool z_number::fits_slong() const { return _n.fits_slong_p(); }
