...
TEST_CASE("wto figure 1", "[wto]") {
    ...
    // Add edges.
    cfg.add_child(label_t::entry, label_t{1});
    cfg.add_child(label_t{1}, label_t{2});
    cfg.add_child(label_t{2}, label_t{3});
    cfg.add_child(label_t{3}, label_t{4});
    cfg.add_child(label_t{4}, label_t{5});
    cfg.add_child(label_t{4}, label_t{7});
    cfg.add_child(label_t{5}, label_t{6});
    cfg.add_child(label_t{6}, label_t{5});
    cfg.add_child(label_t{6}, label_t{7});
    cfg.add_child(label_t{7}, label_t{3});
...
TEST_CASE("wto figure 2a", "[wto]") {
    ...
    cfg.add_child(label_t::entry, label_t{1});
    cfg.add_child(label_t{1}, label_t{2});
    cfg.add_child(label_t{1}, label_t{4});
    cfg.add_child(label_t{2}, label_t{3});
...
TEST_CASE("wto figure 2b", "[wto]") {
    ...
    cfg.add_child(label_t{1}, label_t{4});
    cfg.add_child(label_t{2}, label_t{3});
    cfg.add_child(label_t{3}, label_t{1});
    cfg.add_child(label_t{3}, label_t::exit);
    cfg.add_child(label_t{4}, label_t{3});
