...
TEST_SECTION("cilium", "bpf_xdp_dsr_linux.o", "2/16")
...
TEST_SECTION("cilium", "bpf_xdp_snat_linux.o", "2/16")
...
// Unsupported: Integer overflow during addition
TEST_SECTION_FAIL("ovs", "datapath.o", "tail-2")
TEST_SECTION_FAIL("ovs", "datapath.o", "tail-32")
TEST_SECTION_FAIL("ovs", "datapath.o", "downcall")
